...
#include "func/yuv_player.h"

const char *j_class = "julis/wang/ffmpeglearn/MainActivity";
const char *j_yuv_player_class = "julis/wang/ffmpeglearn/yuv/YuvPlayer";
...
void load_yuv(JNIEnv *env, jobject thiz, jstring url, jobject surface) {
    yuv_player().load_yuv(env, thiz, url, surface);
}
...
jint RegisterNatives(JNIEnv *env) {
    ...
    jclass yuv_player_class = env->FindClass(j_yuv_player_class);
    JNINativeMethod yuv_player[] = {
            {"loadYuv", "(Ljava/lang/String;Ljava/lang/Object;)V", (void *) load_yuv},
    };
    env->RegisterNatives(yuv_player_class, yuv_player,
                         sizeof(yuv_player) / sizeof(yuv_player[0]));
